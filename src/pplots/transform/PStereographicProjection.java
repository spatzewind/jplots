...
public class PStereographicProjection implements PProjection {
	
	private double cenlat,cenlon, updir, earth_scale;
	private double[][] rotmat_p2x, rotmat_x2p;
	
	public PStereographicProjection(double center_longitude, double center_latitude, double upward_direction, boolean in_degree) {
