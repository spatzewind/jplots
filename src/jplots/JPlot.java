...
public class JPlot {
	...
	public JPlot subplots(double width, double height, int nrows, int ncols, Object... kwargs) {
		...
		this.img_is_created = false;
		if (kwargs != null)
			for (Object kwarg2 : kwargs) {
				if (kwarg2 instanceof String) {
					String kwarg = (String) kwarg2;
	...
	public JPlot addSubplot(double pos_x, double pos_y, double width, double height) {
		...
		for (int a = 0; a < axes.length; a++)
			tempa[a] = axes[a];
		tempa[axes.length] = new JAxis(this, (int) (pos_x * this.width), (int) (pos_y * this.height),
